...
public class UsuarioController {
	...
	public ResponseEntity<?> cadastrarProduto(@PathVariable(value = "id_usuario") Long idUsuario,
	...
	public ResponseEntity<?> removerProduto(@PathVariable(value = "id_Produto") Long idProduto,
